...
#include "../List_3/LinkedList.h"
#include "../List_3/ScoreData.h"
...
TEST_F(InserDataF, InsertWithConstIteratorToBegin)
{
...

	{
		...
		TestData[0] = { 13, "Test13" };
		TestData[1] = { 15, "Test13_Center" };
		TestData[2] = { 0, "Test0" };
		TestData[3] = { 1, "Test1" };
		TestData[4] = { 2, "Test2" };
		TestData[5] = { 14, "Test13_End" };
